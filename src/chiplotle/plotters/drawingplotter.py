...
class _DrawingPlotter(_BasePlotter):
    ...
    def set_origin_bottom_left(self):
      ...
      """
        ...
        self.write(
            self._hpgl.SC([(0, self.margins.soft.width), (0, self.margins.soft.height)])
        )
    ...
    def set_origin_top_left(self):
      ...
      """
        ...
        self.write(
            self._hpgl.SC(
                [(0, self.margins.soft.width), (0, -self.margins.soft.height)]
            )
        )
    ...
    def set_origin_bottom_right(self):
      ...
      """
        ...
        self.write(
            self._hpgl.SC(
                [(-self.margins.soft.width, 0), (self.margins.soft.height, 0)]
            )
        )
    ...
    def set_origin_center(self):
      ...
      """
        ...
        self.write(self._hpgl.SC([(-w_div_2, w_div_2), (-h_div_2, h_div_2)]))
